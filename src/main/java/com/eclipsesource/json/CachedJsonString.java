...
public class CachedJsonString {
    ...
    public CachedJsonString(String wrappedString) {
    ...
    public static abstract class Key {
        ...
        /*
        Since there is very few collisions on strings, computing the string hashcode the "pure-way"
        is more expensive. Use a simple/faster algorithm for hash code and validate in "equals"
        using a "purist" algorithm.
         */
        @Override
        public int hashCode() {
            if (cachedHashCodeFast == 0) {
                if (length == 0) {
                    ...
                    cachedHashCodeFast = length << 24 | charArray[startIdx] << 16 | charArray[secondCharIdx] << 8 | charArray[lastCharIdx];
                }
            }
